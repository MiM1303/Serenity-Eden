        ...
        <div>
            ...
            <div className="mx-2 lg:mx-10">
                <div className="flex justify-center items-center flex-col gap-10 lg:flex-row">
                    <img src={image_url} className="w-2/3 rounded-lg shadow-2xl" />
                    <div className=''>
                        ...
                        <div className='flex flex-col md:flex-row lg:flex-row gap-2 lg:gap-4'>
                            {
                                facilities.map(facility =>
                                    <span key={id} className=" mb-3 w-fit  bg-[#93d6db] rounded-xl shadow-md py-1 px-3 text-base lg:text-lg">{facility}</span>
                                )
                            }
                        </div>
