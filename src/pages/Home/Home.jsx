...
const Home = () => {
    ...
    return (
        <div>
            ...
            <Slider></Slider>
            <div className="text-center mt-16 mb-14 lg:mt-12">
                <h2 className="mb-4 text-xl md:text-2xl lg:text-4xl font-semibold text-[#264369]">Our Estates</h2>
                <p className="w-10/12 md:w-10/12 lg:w-3/4 md:text-lg lg:text-xl font-normal text-[#196680] mx-auto">Welcome to our curated collection of exceptional properties, where luxury meets tranquility. Explore our portfolio of beachfront villas, private island retreats, modern penthouses, and more. Each property is meticulously selected for its unique charm, breathtaking views, and lavish amenities. Discover your dream sanctuary with us.</p>
            </div>
            ...
            <div className="lg:flex lg:flex-col lg:justify-center lg:items-center lg:mt-16">
                <div className="text-center mt-16 mb-10 lg:mt-12">
                    <h2 className="mb-4 text-xl md:text-2xl lg:text-4xl font-semibold text-[#264369]">Our Location</h2>
                </div>
                <div>
