    ...
    return (
        <div>
            ...
            <footer className="mt-6 md:mt-8 lg:mt-12 footer footer-center p-10 bg-gradient-to-b from-[#0f7994] from-10% via-[#196680] via-30% to-[#2e4057] text-primary-content">
                <aside>
                    <GiHummingbird  className="text-[#2CB1CF] text-5xl lg:text-6xl font-semibold"/>
                    <p className="font-bold text-2xl lg:text-3xl">
                    Serenity Eden </p>
                    
                    <p>Providing reliable real estates since 2000</p> 
                    <br/> 
                    <p className="text-xs mb-0">Copyright © 2024 - All right reserved</p>
                </aside> 
                <nav>
